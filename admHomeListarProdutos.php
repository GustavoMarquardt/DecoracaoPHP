            ...
            <div class="imgLogo">
                ...
                <form>
                    <div class="mb-3" style="margin-left:5%">
                        <label for="filtro" class="form-label" style="color: #fff;">Pesquisar</label>
                        <input type="email" class="form-control" id="filtro" aria-describedby="emailHelp"
                        style="width: 40%;">
                        <button type="submit" class="btn btn-primary" style="margin-top: 2%;" onkeyup="carregar_filtro(this.value)">Submit</button>
                    </div>
